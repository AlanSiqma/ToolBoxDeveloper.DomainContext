...
namespace ToolBoxDeveloper.DomainContext.MVC.Domain.Settings
{
    public class CryptographySettings
    {
        ...
        private CryptValueObject _CryptValueObject;
        ...
        private void SetIV()
        {
            switch (_CryptValueObject)
            {
                case CryptValueObject.Rijndael:
        ...
        public CryptographySettings()
        {
            ...
            _CryptValueObject = CryptValueObject.Rijndael;
        }
        /// <summary>
        ...
        public CryptographySettings(CryptValueObject cryptProvider)
        {
            ...
            switch (cryptProvider)
            {
                case CryptValueObject.Rijndael:
                    ...
                    _CryptValueObject = CryptValueObject.Rijndael;
                    break;
                case CryptValueObject.RC2:
                    _algorithm = new RC2CryptoServiceProvider();
                    _CryptValueObject = CryptValueObject.RC2;
                    break;
                case CryptValueObject.DES:
                    _algorithm = new DESCryptoServiceProvider();
                    _CryptValueObject = CryptValueObject.DES;
                    break;
                case CryptValueObject.TripleDES:
                    _algorithm = new TripleDESCryptoServiceProvider();
                    _CryptValueObject = CryptValueObject.TripleDES;
                    break;
            }
            _algorithm.Mode = CipherMode.CBC;
        }
            ...
            if (_algorithm.LegalKeySizes.Length > 0)
            {
                ...
                else if (keySize < maxSize)
                {
                    ...
                    if (keySize < validSize)
                    {
                        ...
                        _key = _key.PadRight(Convert.ToInt32(validSize / 8), '*');
                    }
                }
            }
